        ...
        .on('done', function(layer) {
            ...
            var LayerActions = {
                ...
                fdp: function() {
                    sublayers[0].set({
                        sql: "SELECT * FROM btw13",
                        cartocss: '#btw13{polygon-fill:#FFFFB2;polygon-opacity:.8;line-color:#FFF;line-width:.5;line-opacity:1}#btw13 [fdp<=10.1]{polygon-fill:#ecbd00;polygon-opacity:1}#btw13 [fdp<=8]{polygon-fill:#ecbd00;polygon-opacity:.8}#btw13 [fdp<=7]{polygon-fill:#ecbd00;polygon-opacity:.6}#btw13 [fdp<=6.2]{polygon-fill:#ecbd00;polygon-opacity:.4}#btw13 [fdp<=5.4]{polygon-fill:#ecbd00;polygon-opacity:.2}'
                    });
                    return true;
                },
                afd: function() {
